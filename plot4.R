...
par(mfcol = c(2, 2)) 
# plot1 col:1 row:1
plot(hpcts$datetime, as.numeric(hpcts$Global_active_power), type="l", ylab="Global Active Power", xlab="")
# plot1 col:1 row:2
...
# plot1 col:2 row:2
plot(hpcts$datetime, as.numeric(hpcts$Global_reactive_power), type="l", ylab=colnames(hpcts)[5], xlab=colnames(hpcts)[1])
dev.off()